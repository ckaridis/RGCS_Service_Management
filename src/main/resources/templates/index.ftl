...
<body>
   ...
   <div id="page_wrapper">
       ...
       <div id="hero_wrapper">
          <h1>RGCS MOTORS.</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sollicitudin rhoncus mi id ornare. Mauris luctus, tortor vel sagittis rhoncus, turpis augue interdum eros, sit amet iaculis sapien velit sed turpis. Donec eu enim nibh. Integer orci nibh, volutpat ac magna quis, pulvinar pretium diam. Mauris facilisis pretium dignissim. Duis vestibulum elit non augue suscipit elementum. Aenean ut justo tellus.
          </p>
       </div>
